...
public class ImageInfo extends Magick {
     ...
     * <pre>TIFF Directory at offset 0x0
        ...
        Software: ImageMagick 6.2.6 10/06/06 Q8 http://www.imagemagick.org</pre>
     * <p>Note: The verbose setting is primarily for use with the utility programs.
        ...
        output when loading a PDF or PS file.</p>
