...
public interface FilterType {
	/*
		...
		http://trac.imagemagick.org/browser/ImageMagick/branches/ImageMagick-6.6.2/magick/resample.h
	*/
	...
	public final static int LanczosFilter = 13;
	public final static int BesselFilter = 14;
	public final static int SincFilter = 15;
	public final static int KaiserFilter = 16;
	public final static int WelshFilter = 17;
	public final static int ParzenFilter = 18;
	public final static int LagrangeFilter = 19;
	public final static int BohmanFilter = 20;
	public final static int BartlettFilter = 21;
	public final static int SentinelFilter = 22;
}
